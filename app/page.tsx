      ...
      <header className="container mx-auto py-6">
        <div className="flex items-center justify-between">
          <Link href="/" className="text-xl font-bold tracking-tighter">
            <span className="text-purple-500">A</span>v
            <span className="text-purple-500">I</span>Lash
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <h1 className="text-4xl md:text-6xl font-bold leading-tight">
                Tracking the pulse of AI and tech by <span className="text-purple-500">Avilash</span>
              </h1>
              <p className="text-gray-400 text-lg md:text-xl">
                Deep insights into AI, GenAI, Computer Vision, Tech and Deep Learning advancements.
              </p>
